...
export const reviewboxContent = {
  ...
  subtext:
    "Reviewbox helps your customers leave consistent, quality reviews on Google, Yelp, and Facebook—so your reputation keeps growing while you stay focused on the work.",
  productLink: {
    label: "Reviewbox",
    href: "https://reviewbox.io",
  },
